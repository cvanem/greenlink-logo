import { a as createCommonjsModule, b as unwrapExports, m as _objectWithoutProperties, n as _extends, o as _defineProperty, p as warning, q as deepmerge, r as isPlainObject, s as withStylesWithoutDefault, t as clsx, u as require$$0, k as __extends, l as AnimateMapped } from './chunk-7c1f2c03.js';
...
var SvgIcon = require$$0.forwardRef(function SvgIcon(props, ref) {
  var _clsx;
  ...
  return require$$0.createElement(Component, _extends({
    ...
    ref: ref
  }, other), children, titleAccess ? require$$0.createElement("title", null, titleAccess) : null);
});
...
var require$$1 = withStyles(styles, {
  name: 'MuiSvgIcon'
})(SvgIcon);
...
var GreenlinkSvgIcon = createSvgIcon(function () {
    ...
    Logo.prototype.render = function () {
        ...
        return (createElement(AnimateMapped, { animate: animate },
            createElement("div", { style: { position: "relative", height: height } },
                createElement(GreenlinkSvgIcon, { viewBox: "0 0 38.69 17.14", htmlColor: color ? color : "#92C83E", style: { width: "100%", height: "100%" } }))));
    };
    return Logo;
}(Component));

export default Logo;
export { logoHeightMap, logoWidthMap };
//# sourceMappingURL=Logo-d0fb7b1c.js.map
